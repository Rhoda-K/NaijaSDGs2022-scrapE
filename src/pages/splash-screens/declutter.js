...
import { ReactComponent as PageIcon } from "../../assets/images/declutter.svg";
import { ReactComponent as EllipsisIcon } from "../../assets/icons/ellipsis1.svg";
  ...
  return (
    <Container>
      <CenteredContainer direction="column" height="100%">
        <PageIcon />
        <PageTitle top="6.8rem">Declutter.</PageTitle>
        <Text top="2.5rem" align="center" width="30.6rem">
          Keep the ecosystem clean. Free up space; let go of junks properly!
        </Text>
      ...
      <ButtonContainer>
        ...
        <Link to="/splash-two" style={{ textDecoration: "none" }}>
          <ArrowIcon />
        </Link>
      </ButtonContainer>
    </Container>
